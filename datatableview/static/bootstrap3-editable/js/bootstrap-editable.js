...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
       ...
       value2html: function(value, element) {
           ...
           if(this.isMultiple) { //AJOUT pour que le many to many fonctionne #TODO embedded this
               if (data == undefined) {
                   data= [];
               }
           ...
           if($.isArray(data)) {
               ...
               text = [];
               for(var i = 0; i<data.length; i++) {//AJOUT #TODO embedded this
                   if ($.inArray(data[i]['id'], value) !== -1 ){
                       text.push(that.formatSelection(data[i]));
                   }
               }
           } else if(data) {
               text.push(that.formatSelection(data));
           }
