...
class DatatableTests(DatatableViewTestCase):
    ...
    def test_sort_uses_all_sources(self):
        ...
        obj1.date_created = (obj1.date_created + timedelta(days=3)).replace(tzinfo=datetime.timezone.utc)
        obj2.date_created = (obj2.date_created + timedelta(days=1)).replace(tzinfo=datetime.timezone.utc)
        obj3.date_created = (obj3.date_created + timedelta(days=2)).replace(tzinfo=datetime.timezone.utc)
        obj1.save()
        obj2.save()
        obj3.save()
